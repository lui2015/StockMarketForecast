...
请求体（JSON）：
{
  "market": "A_INDEX | HK_INDEX | US_INDEX | A_STOCK | HK_STOCK | US_STOCK",
  "symbol": "标的代码（编码规则见下文）",
  "direction": "UP 或 DOWN",
...
- 美股个股: 内部代码 us+ ticker 小写，如 usaapl（苹果）；symbol_name 必填，建议提交真实股票名称
- 个股预测需填写 symbol_name（股票名称）；网页端支持输入名称自动获取代码
